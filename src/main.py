...
PROJECT = {
  "code": "P06",
  "slug": "imc-classifier-python-lab",
  "title": "IMC Classifier Python Lab",
  "discipline": "Logic and Programming Language I",
  "disciplinePt": "Logica e Linguagem de Programacao I",
  "difficulty": "Introductory",
  "difficultyPt": "Introdutorio",
  "kind": "imc",
  "dataset": "Synthetic body-measurement sample",
  "source": "Local synthetic sample",
  "description": "Pure Python and pandas lab for BMI calculation, classification, and optional CSV input.",
  "concepts": [
    "variables",
    "conditionals",
    "functions",
